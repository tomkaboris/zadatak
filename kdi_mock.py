...
def main():
    ...
    parser.add_argument('--base_dir', type=str, default='izvodi', help='Base directory to create (str). Default: izvodi')
    parser.add_argument('--num_ids', type=int, default=5, help='Number of ID directories to create (int). Default: 5')
    parser.add_argument('--id_length', type=int, default=5, help='Length of each numeric ID (int). Default: 5')
    parser.add_argument('--start_date', type=str, default='2024-09-10', help='Start date for date directories (YYYY-MM-DD). Default: 2024-09-10')
    parser.add_argument('--end_date', type=str, default='2024-11-10', help='End date for date directories (YYYY-MM-DD). Default: 2024-11-10')
    parser.add_argument('--min_dates', type=int, default=2, help='Min number of date directories per ID (int). Default: 2')
    parser.add_argument('--max_dates', type=int, default=15, help='Max number of date directories per ID (int). Default: 15')
    parser.add_argument('--min_partija', type=int, default=2, help='Min number of partije per date directory (int). Default: 2')
    parser.add_argument('--max_partija', type=int, default=6, help='Max number of partije per date directory (int). Default: 6')
    parser.add_argument('--num_orgs', type=int, default=2, help='Number of organizations with potential access based on merge probability (int). Default: 2')
    parser.add_argument('--per_acc', type=float, default=0.5, help='Merge probability with other organizations (float, e.g., 0.5 = 50.percent). Default: 0.5')
